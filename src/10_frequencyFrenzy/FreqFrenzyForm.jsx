...
import { freqFrenzyAlgo } from "./freqFrenzyAlgo";

export const FreqFrenzyForm = () => {
    ...
    const handleCalculate = () => {
        setResult(freqFrenzyAlgo(frequencyChanges));
        setHidden(false);
    }
    ...
    return (<>
        <form>
            <Button color="success" variant="contained" onClick={handleCalculate} sx={{ margin: '16px 16px 16px 0px' }}>Calculate</Button>
            <Button color="error" variant="contained" onClick={handleReset} sx={{ margin: '16px' }}>Reset</Button>
            <Divider />
            <div>
                {hidden ? "" : <h3>Resulting Frequency: <em>{result}</em></h3>}
            </div>
        </form>
    </>)
}